...
list_of_files = [
    ...
    f"src_{project_name}/__init__.py", # source folder and init contructor file
    f"src_{project_name}/components/__init__.py",
    f"src_{project_name}/utils/__init__.py", 
    f"src_{project_name}/config/__init__.py",
    f"src_{project_name}/config/configuration.py",
